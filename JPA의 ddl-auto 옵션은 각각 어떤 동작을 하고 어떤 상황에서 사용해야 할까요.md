---
created: 2025-12-12T08:00
updated: 2026-01-25T13:50
---
# 내 답변
프로그램이 시작될때 jpa entity로 등록된 객체를 db에 ddl 하는지에 대한 옵션입니다 
auto,update,none 의 옵션이 있으며
auto는 프로그램이 시작될 때 모든 table을 drop 시키고 entity를 모두 생성해줍니다
update는 기존 db에 저장되지 않은 entity를 생성해주며
none은 아무 동작도 하지 않습니다
